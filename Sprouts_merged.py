...
class GameView:
    ...
    def displayPlayer(self):
        if controller.getTurn():
            self.drawText('Player 1', view.font, system.blue, system.screen, system.height/2, system.width/20)
        else:
            self.drawText('Player 2', view.font, system.red, system.screen, system.height/2, system.width/20)
