    ...
    while True:
        ...
        if button_1.collidepoint((mx,my)) and error_text == '':
            ...
            if click:
                ...
                play = 1
                while play:
                    play = libDrawing.playGame(int(slider_no))
                    pass
        else:
        ...
        if button_2.collidepoint((mx,my)) and error_text == '':
            ...
            if click:
                ...
                play = 1
                while play:
                    play = libAdvanced.playGame(int(slider_no), False, [])
        else:
        ...
        draw_text('Drawing', font_h, (255,255,255), screen, 400, 285)
    ...
    try:
        with open(filename, 'r') as f:
            ...
            if checkValidFile(lines):
                libAdvanced.playGame(int(lines[0]), True, lines[1:]) # start txt-file version
            else:
